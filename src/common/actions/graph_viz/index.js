...
import * as graphioGremlin from '../gremlin'
import * as graphShapes from '../graph_shapes'
...
export 	 { svg_handle,nodes,links,nodes_data,node_data,
	links_data,init,create_arrows,addzoom,clear,get_simulation_handle,
	simulation_start,refresh_data,layers,graph_events };
